...
pub struct Ps3decargs {
    #[clap(short, long, help = "The path to the PS3 ISO file to encrypt/decrypt.")]
    pub iso: String,
    ...
    #[clap(short, long, help = "Encrypt ISO rather than decrypt it.", action = clap::ArgAction::SetTrue)]
    pub encrypt: bool,
